...
public class MeetUpController {
    ...
    public ResponseEntity<MeetUpResponseDto> updateMeetUp(@PathVariable("id") Long id, @PathVariable("username") String username, @Valid @RequestBody MeetUpDto meetUpDto) {
        ...
        // Renvoyer une réponse 404 si le meetUp n'existe pas ou si la mise à jour n'est pas autorisée
        return ResponseEntity.notFound().build();
    }
}